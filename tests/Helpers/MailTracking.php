...
trait MailTracking
{
    ...
    /**
     * Assert that the last email was delivered to the given recipient.
     *
     * @param string        $recipient
     * @param Swift_Message $message
     */
    protected function seeEmailToName($recipient, Swift_Message $message = null)
    {
        $this->assertContains(
            $recipient,
            (array) $this->getEmail($message)->getTo(),
    ...
    /**
     * Assert that the last email was delivered by the given sender.
     *
     * @param string        $sender
     * @param Swift_Message $message
     */
    protected function seeEmailFromName($sender, Swift_Message $message = null)
    {
        $this->assertContains(
            $sender,
            (array) $this->getEmail($message)->getFrom(),
